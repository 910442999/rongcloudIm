...
import com.ycjt.rongcloudim.common.IntentExtra;
import com.ycjt.rongcloudim.common.ResultCallback;
import com.ycjt.rongcloudim.db.DbManager;
import com.ycjt.rongcloudim.im.message.SealContactNotificationMessage;
import com.ycjt.rongcloudim.im.message.SealGroupNotificationMessage;
import com.ycjt.rongcloudim.im.provider.ContactNotificationMessageProvider;
import com.ycjt.rongcloudim.im.provider.SealGroupNotificationMessageItemProvider;
import com.ycjt.rongcloudim.model.ContactNotificationMessageData;
import com.ycjt.rongcloudim.model.Resource;
import com.ycjt.rongcloudim.model.UserCacheInfo;
import com.ycjt.rongcloudim.sp.UserCache;
import com.ycjt.rongcloudim.sp.UserConfigCache;
import com.ycjt.rongcloudim.utils.log.LogTag;
import com.ycjt.rongcloudim.utils.log.SLog;
    ...
    private void initConversation() {
        ...
        RongIM.setConversationClickListener(new RongIM.ConversationClickListener() {
            ...
            public boolean onUserPortraitClick(Context context, Conversation.ConversationType conversationType, UserInfo userInfo, String s) {
                Toast.makeText(context, "跳转用户详情", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMessageClick(Context context, View view, Message message) {
                if (message.getContent() instanceof ImageMessage) {
                    Toast.makeText(context, "密封图片寻呼机活动", Toast.LENGTH_SHORT).show();
            ...
            public boolean onConversationClick(Context context, View view, UIConversation uiConversation) {
                ...
                if (messageContent instanceof ContactNotificationMessage) {
                    ...
                    if (contactNotificationMessage.getOperation().equals("AcceptResponse")) {
                        ...
                        Toast.makeText(context, "NewFriendListActivity", Toast.LENGTH_SHORT).show();
